...
if(args[0].toLowerCase() === 'ekle') {
  ...
  if (!usr) return message.channel.send(new Discord.MessageEmbed().setDescription('Komutu kullanabilmek için [sunucumda](https://discord.gg/UhnzKpztUu) bulunman gerekiyor!'));
